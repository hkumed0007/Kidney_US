...
validity_weights = os.path.join(base_dir, 'trained_Invalid_vs_valid_DN121.pth')
single_label_weights = os.path.join(base_dir, 'trained_ValidsDN121.pth')
multi_label_weights = os.path.join(base_dir, 'trained_multi_label_model.pth')

# Debug info
print(f"Loading weights from:")
print(f"- Validity: {validity_weights} (exists: {os.path.exists(validity_weights)})")
print(f"- Single Label: {single_label_weights} (exists: {os.path.exists(single_label_weights)})")
print(f"- Multi Label: {multi_label_weights} (exists: {os.path.exists(multi_label_weights)})")
